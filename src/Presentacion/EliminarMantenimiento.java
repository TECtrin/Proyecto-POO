 ...
 * @author brend
 */
public class EliminarMantenimiento extends javax.swing.JFrame {

    /**
     * Creates new form EliminarMantenimiento
     */
    public EliminarMantenimiento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Eliminar Servicio");
        ...
        jPanel1.add(jButtonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 350, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarMantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarMantenimiento().setVisible(true);
            }
        });
    }
